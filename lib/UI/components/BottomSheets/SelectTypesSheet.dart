...
Widget SelectTypeSheet(BuildContext context) {
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      for (var slot in [1,2,3]) Container(
                          ...
                          child: Row(
                            children: [
                              Container(
                                ...
                                width: 15,
                                decoration: BoxDecoration(
                                    color:   snapshot.data!['types'].contains(slot)
                                        ? UIIconColors.active
                                        : Colors.white,
                              ...
                              semiHeader(WashesBloc.typesHardCode[slot])
                            ],
                          ),
                          onTap: () {
                            if (snapshot.data!['types'].contains(slot)){
                              print("!");
                              List<int> l = snapshot.data!['types'];
                              l.remove(slot);
                              washesBloc.setTypes(l);
