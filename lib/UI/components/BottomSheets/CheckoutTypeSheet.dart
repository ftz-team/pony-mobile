...
Widget CheckoutSheetType(BuildContext context, List<dynamic> aviable) {
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      for (int i = 0; i<  aviable.length; i++) Container(
                        ...
                        child: InkWell(
                          child: Row(
                            children: [
                              ...
                              semiHeader(aviable[i]['type_name']+" ("+aviable[i]['price'].toString()+"₽)")
                            ],
                          ),
                          onTap: () {
                            checkoutBloc.setType(i);
                          },
                        ),
                      ),
                    ],
